...
import { Home, Clipboard, Settings, Camera } from "lucide-react";
...
export default function WorkerNavbar() {
  ...
  const NAV = [
    ...
    { href: "/worker/complaints", label: "My Complaints", icon: Clipboard },
    { href: "/worker/camera", label: "Cameras", icon: Camera },
